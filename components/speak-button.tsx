...
export default function SpeakButton({
  ...
  const buttonClass = size === "small" ? "p-1" : "p-2"
  const svgClass = size === "small" ? "w-4 h-4" : "w-5 h-5"
  return (
    <button className={"inline-block text-center text-white transition border border-blue-500 rounded-full ripple hover:bg-blue-100 focus:outline-none waves-effect " + buttonClass} onClick={speak}>
      <svg className={"text-blue-500 " + svgClass} viewBox="0 0 576 512" fill="currentColor" >
