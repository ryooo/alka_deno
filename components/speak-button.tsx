...
export default function SpeakButton({
  ...
  return (
    <button className="inline-block p-3 text-center text-white transition border border-blue-500 rounded-full ripple hover:bg-blue-100 focus:outline-none waves-effect " onClick={speak}>
      <svg className="w-5 h-5 text-blue-500" viewBox="0 0 576 512" fill="currentColor" >
